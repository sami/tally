...
class TestApplyEntryCommand(unittest.TestCase):
    def setUp(self):
        self.ledger = Ledger()
        self.ledger.reset()
    ...
    def test_execute_alters_balances_and_undo_reverts_them(self):
        ...
        self.assertEqual(self.ledger.get_balance("Sami"), 0)

        # Execute
        self.ledger.execute(command)

        # Post-execution: Sami paid 3000, his share is 1000. Net +2000.
        # Mariam and Yusuf each share 1000. Net -1000.
        self.assertEqual(self.ledger.get_balance("Sami"), 2000)
        self.assertEqual(self.ledger.get_balance("Mariam"), -1000)
        self.assertEqual(self.ledger.get_balance("Yusuf"), -1000)
        ...
        # Reverted back to 0
        self.assertEqual(self.ledger.get_balance("Sami"), 0)
        self.assertEqual(self.ledger.get_balance("Mariam"), 0)
        self.assertEqual(self.ledger.get_balance("Yusuf"), 0)
